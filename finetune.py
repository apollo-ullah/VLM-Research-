...
def main():
    ...
    try:
        with open(paths["train_captions_file"], "r") as f:
            captions_data = json.load(f)
        
        # Apply filtering to clean captions using the dataset module's function
        filtered_captions = filter_captions(captions_data)
        
        # Save filtered captions to a new file
        filtered_path = paths["train_captions_file"].replace(".json", "_filtered.json")
